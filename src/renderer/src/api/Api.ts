...
export default {
  ...
  fetch(url: any, tips: any, options: any) {
  ...
  async request(uri: string, tips: any, options: any) {
    const user = useUserStore()
    ...
    options.url = uri
    return await this.fetch(uri, tips, options)
  },

  get(uri: string, params = {}, tips = {}, options = {}) {
    return this.request(uri, tips, Object.assign(options, { method: 'GET', params }))
  },

  post(uri: string, data: any = null, tips = {}, options = {}) {
    return this.request(uri, tips, Object.assign(options, { method: 'POST', data }))
  }
}
